...
const PrivacyPolicy = () => {
    return (
        <div className="policy-section">
            <h2 className="policy-heading">מדיניות פרטיות ל-HORSEHUB</h2>
            <p className="policy-date">תאריך עדכון אחרון: 08/2025</p>

            <p className="policy-intro">
                ברוכים הבאים ל-HORSEHUB. אנו מחויבים להגן על הפרטיות ולשמור על המידע שאתה משתף איתנו בעת השימוש באתר שלנו, שממוקם בכתובת <strong>horsehub.team@gmail.com</strong>.
            ...
            <div className="policy-section-block">
                ...
                <ul>
                    ...
                    <li><strong>מידע אישי:</strong> שם, טלפון, דוא"ל, כתובת מגורים, תיאורי פרסום, תמונות, קורות חיים של סוסים.</li>
            ...
            <div className="policy-section-block">
                ...
                <ul>
                    <li>לסייע במכירת פרסום של סוסים, זרע, אביזרים ומוצרים נוספים.</li>
