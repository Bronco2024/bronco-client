        ...
        <div className="about-section">
            <div className="about-content">
                ...
                <div className="about-text-container">
                    <h2 className="about-heading">ברונקו – הדהירה שלך מתחילה כאן</h2>
                    <p className="about-description">
                        ברונקו היא הפלטפורמה המובילה בישראל לאוהבי סוסים, רוכבים, מגדלים ואנשי מקצוע. יצרנו מקום אחד שמרכז את כל מה שצריך – לקנייה, טיפול, למידה וחוויה – והכל ברמה הגבוהה ביותר
                    </p>
                ...
                <div className="feature-extra-text">
                    <p>אנחנו מאמינים בשירות אישי, מקצועיות בלתי מתפשרת ואהבה אמיתית לעולם הסוסים.<br />
                        ברונקו הוא לא רק אתר – זו קהילה. זו דרך חיים.</p>
                    <p><strong>ברוכים הבאים ל־ברוקו, המקום שבו הכל מתחיל</strong></p>
                </div>
