/**
 * This component is currently not in use. until customer request it.
 * 
 */
...
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faHorse, faShoppingCart, faClock } from "@fortawesome/free-solid-svg-icons";
import './OurProducts.css';

const OurProducts = () => {
    return (
        <div className="coming-soon-wrapper">
            <FontAwesomeIcon icon={faClock} className="coming-soon-icon" />
            <h2 className="coming-soon-title">בקרוב בחנות!</h2>
            <p className="coming-soon-text">
                אנחנו עובדים על להביא לכם מוצרים מדהימים בקרוב. הישארו מעודכנים!
            </p>
            <FontAwesomeIcon icon={faHorse} className="coming-soon-icon" />
            <FontAwesomeIcon icon={faShoppingCart} className="coming-soon-icon" />
        </div>
    );
};
